...
typedef void (^BFDiskCacheBlock)(BFDiskCache *cache);
typedef void (^BFDiskCacheObjectBlock)(BFDiskCache *cache, NSString *key, id <NSCoding> object, NSURL *fileURL);

@interface BFDiskCache : NSObject
 ...
 */
@property (copy) BFDiskCacheObjectBlock willAddObjectBlock;

/**
 A block to be executed just before an object is removed from the cache. The queue waits during execution.
 */
@property (copy) BFDiskCacheObjectBlock willRemoveObjectBlock;
 ...
 */
- (void)trimToDate:(NSDate *)date block:(BFDiskCacheBlock)block;
...
/**
 ...
 @param block A block to be executed serially after the cache has been trimmed, or nil.
 */
- (void)trimToSize:(NSUInteger)byteCount block:(BFDiskCacheBlock)block;
...
/**
 ...
 @param block A block to be executed serially after the cache has been trimmed, or nil.
 */
- (void)trimToSizeByDate:(NSUInteger)byteCount block:(BFDiskCacheBlock)block;
