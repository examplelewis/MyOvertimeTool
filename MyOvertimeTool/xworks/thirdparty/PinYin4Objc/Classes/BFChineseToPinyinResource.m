...
- (void)initializeResource {
    ...
    if (dataMap) {
        ...
        NSBundle *armBundle = [NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"OkayappsFrameworkUtils" ofType:@"bundle"]];
        NSString *resourceName =[armBundle pathForResource:@"unicode_to_hanyu_pinyin" ofType:@"txt"];
...
+ (BFChineseToPinyinResource *)getInstance {
    static BFChineseToPinyinResource *sharedInstance=nil;
