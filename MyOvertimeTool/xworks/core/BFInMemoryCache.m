...
#error "BbdtekFramework requires ARC support."
#endif

@interface BFMemoryCache()
...
@interface BFImageMemoryCache()
@property (nonatomic, assign) unsigned long long numberOfPixels;
@end

@implementation BFImageMemoryCache
...
- (BOOL)shouldSetObject:(id)object withName:(NSString *)name previousObject:(id)previousObject {
    @synchronized(self) {
        BFASSERT(nil == object || [object isKindOfClass:[UIImage class]]);
