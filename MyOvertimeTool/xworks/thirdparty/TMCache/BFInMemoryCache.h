...
@class BFInMemoryCache;

typedef void (^BFMemoryCacheBlock)(BFInMemoryCache *cache);
typedef void (^BFMemoryCacheObjectBlock)(BFInMemoryCache *cache, NSString *key, id object);

@interface BFInMemoryCache : NSObject
 ...
 */
@property (copy) BFMemoryCacheObjectBlock willAddObjectBlock;
 ...
 */
@property (copy) BFMemoryCacheObjectBlock willRemoveObjectBlock;
 ...
 */
@property (copy) BFMemoryCacheBlock didReceiveMemoryWarningBlock;
 ...
 */
@property (copy) BFMemoryCacheBlock didEnterBackgroundBlock;
 ...
 */
- (void)trimToDate:(NSDate *)date block:(BFMemoryCacheBlock)block;
