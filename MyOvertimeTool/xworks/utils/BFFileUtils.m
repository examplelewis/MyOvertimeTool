...
#import "BFFileUtils.h"
#import "XworksCore.h"

BF_FIX_CATEGORY_BUG(BFFileUtils)

@implementation BFFileUtils
...
{
    return [[BFFileUtils pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[BFFileUtils pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[BFFileUtils pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[BFFileUtils pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[BFFileUtils pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[BFFileUtils pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
